...
final class SmartDealServiceProvider extends AppServiceProvider
{
    private const MIGRATIONS_PATH = 'databases/migrations';

    private const CONFIGS_PATH = 'configs';

    private const MODULE_PREFIX = 'smart-deal';
    ...
    public function register(): void
    {
        ...
        $this->app->register(SmartDealDIServiceProvider::class);
    }
