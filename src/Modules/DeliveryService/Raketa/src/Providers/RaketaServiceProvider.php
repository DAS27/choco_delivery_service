...
final class RaketaServiceProvider extends AppServiceProvider
{
    private const MIGRATIONS_PATH = 'databases/migrations';

    private const CONFIGS_PATH = 'configs';

    private const MODULE_PREFIX = 'raketa';
    ...
    public function register(): void
    {
        ...
        $this->app->register(RaketaDIServiceProvider::class);
        $this->app->register(RaketaRouteServiceProvider::class);
    }
