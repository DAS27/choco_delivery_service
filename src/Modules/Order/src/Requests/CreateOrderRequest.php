...
final class CreateOrderRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'sender_phone' => 'required|string|regex:/^\+7\d{10}$/',
            'recipient_phone' => 'required|string|regex:/^\+7\d{10}$/',
    ...
    public function messages(): array
    {
        return [
            ...
            'sender_phone.regex' => 'Sender phone must be a valid phone number in the format +77071234567.',
            'recipient_phone.required' => 'Recipient phone is required.',
            'recipient_phone.regex' => 'Recipient phone must be a valid phone number in the format +77071234567.',
